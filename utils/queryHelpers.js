...
/**
* Check if a query is about making a reservation
* @param {string} query - User's query
* @returns {boolean} - Whether the query is about reservations
*/
function isReservationQuery(query) {
  ...
  return reservationTerms.some(term => lowercaseQuery.includes(term));
}
